...
<label for="type">Selecione a campanha a ser removida</label>
<br>
<table class='table'>
	<thead>
        <tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Remover campanha <span id="campanha_id"></span></h4>
      </div>
      <div class="modal-body">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary dimiss-after" id="btn-deletar">Deletar</button>
	      </div>
      	</div>
    </div>
  </div>
...
window.onload = function(){
	...
	$.notify("Atenção! Essa página é destinada a DELETAR campanhas", "warn");
	...
	$('#btn-deletar').click(function(){
		swal({
		  title: "Você tem certeza em deletar esta campanha?",
		  text: "Essa ação acarretará no apagamento permanente da campanha e suas dependências!",
		  type: "warning",
		...
		function(){
		  	$.ajax({
				...
				if(msg['success'] == 'false'){
					swal("Erro!", "Não foi possível deletar a campanha e suas dependências.", "error");
				}else{
					swal({
					  title: "Deletada!",
					  text: "A campanha foi deletada com sucesso.",
					  type: "success",
